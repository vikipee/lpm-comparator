export type aggregationMethod = "weightedHarmonicMean" | "harmonicMean" | "weightedArithmeticMean" | "arithmeticMean" | "weightedGeometricMean" | "geometricMean";


export const aggregate = (method: aggregationMethod, values: number[], weights?: number[]) => {
...
export { weightedHarmonicMean, harmonicMean, weightedArithmeticMean, arithmeticMean, weightedGeometricMean, geometricMean };