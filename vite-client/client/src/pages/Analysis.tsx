        ...
        currentAnalysisPage === 'overview' ? (
          <div className="flex-col items-center justify-center space-y-4">
            ...
            <div className="space-y-6 min-h-[calc(100vh-10rem)]">
              <AnalysisOverview
                report={report}
                setAnalysisPage={setCurrentAnalysisPage}
              />
            </div>
            <div className="flex justify-center space-x-4 mt-6">
              <CustomAlertDialog
                button={<Button size="lg">Start new analysis</Button>}
                title={'Are you sure you want to start again?'}
                description={
                  'This will clear all computed results and start the process from the beginning.'
                }
              ...
              <CustomAlertDialog
                button={<Button size="lg">Edit upload</Button>}
          ...
          <div className="container mx-auto p-4 pt-12 md:pt-4">
            <div className="flex flex-col md:flex-row items-center">
              <Button
                variant="ghost"
                onClick={goBack}
                className="mb-4 md:mb-0 md:mr-4 md:absolute md:top-4 md:left-4 hover:bg-gray-200"
              >
                <ChevronLeft className="mr-2 h-4 w-4" /> Back
              </Button>
              <Tabs
                value={currentAnalysisPage}
                onValueChange={setCurrentAnalysisPage}
