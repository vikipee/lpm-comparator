      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 mb-4">
            <Card
              className="flex-1"
              style={{ borderTop: `3px solid hsl(var(--chart-2))` }}
            >
              <CardContent className="pt-6">
                <PetriNetUpload
                  ...
                  files={lpmsLeft}
                  setFiles={setLpmsLeft}
                />
              </CardContent>
            </Card>
            <Card
              className="flex-1"
              style={{ borderTop: `3px solid hsl(var(--chart-3))` }}
            >
              <CardContent className="pt-6">
                <PetriNetUpload
                  side="Right"
            ...
            <CustomAlertDialog
              button={
                <Button
                  size="lg"
                  disabled={
                    !eventLog || lpmsLeft.length === 0 || lpmsRight.length === 0
                  }
                >
              ...
              description={
                'The computation takes a while and files cannot be changed without another computation.'
              }
