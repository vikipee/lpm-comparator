...
export const SimilaritySelection = ({similarityMeasure, setSimilarityMeasure}: {similarityMeasure: SimilarityMeasure; setSimilarityMeasure: (v: SimilarityMeasure) => void}) => {
    return (
